#!/bin/bash
# Bash Setup Script for Google ADK (macOS / Linux)

echo "========================================"
echo " Setting up Virtual Environment (ADK)..."
echo "========================================"
...
echo -e "\033[1;33mTo run the built-in UI:\033[0m"
echo -e "uv run --env-file .env adk web\n"
